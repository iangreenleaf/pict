defmodule PictWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-teal-800 hover:bg-teal-600 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PictWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PictWeb.Gettext, "errors", msg, opts)
    end
  end
